...
botondiv=Button(miframe,text="/",width=5,pady=10,padx=1)
...
botonmult=Button(miframe,text="x",width=5,pady=10,padx=1)
...
botoncoma=Button(miframe,text=".",width=5,pady=10,padx=1)
botoncoma.grid(row=5,column=2)
botonigual=Button(miframe,text="=",width=5,pady=10,padx=1)
botonigual.grid(row=5,column=3)
botonrestar=Button(miframe,text="-",width=5,pady=10,padx=1)
